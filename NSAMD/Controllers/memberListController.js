...
function MemberListController($scope, $mdDialog, $mdMedia, $log, memberService, appNotificationService, appService, $state, localStorageService) {
...
MemberListController.$inject = ['$scope', '$mdDialog', '$mdMedia', '$log', 'memberService', 'appNotificationService', 'appService', '$state', 'localStorageService'];

angular.module('app').controller('memberListController', MemberListController);
